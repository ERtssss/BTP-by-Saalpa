...
struct MoveInputState {
    ...
    bedrocktoolsplus::sdk::Vec2 mAnalogMoveVector;
...
struct MoveInputComponent {
    ...
    bedrocktoolsplus::sdk::Vec2 mMove;
    bedrocktoolsplus::sdk::Vec2 mLookDelta;
    bedrocktoolsplus::sdk::Vec2 mInteractDir;
    bedrocktoolsplus::sdk::Vec3 mDisplacement;
    bedrocktoolsplus::sdk::Vec3 mDisplacementDelta;
    bedrocktoolsplus::sdk::Vec3 mCameraOrientation;
