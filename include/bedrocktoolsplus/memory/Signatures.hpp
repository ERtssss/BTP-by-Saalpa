...
BEDROCKTOOLSPLUS_API bool resolveAll(std::string_view libraryName = "libminecraftpe.so");
BEDROCKTOOLSPLUS_API std::uintptr_t resolve(SignatureId id);
BEDROCKTOOLSPLUS_API void clear();
