...
public:
    explicit ScopedEmptyReservedAreas(void* self) {
        ...
        m_vector = reinterpret_cast<RawVectorHeader*>(
            ...
            ::bedrocktc::sdk::offsets::ControlOptionEditorControl::mReservedAreas
        );
        ...
        if (m_savedBegin == 0 ||
            ...
            ((m_savedEnd - m_savedBegin) %
             ::bedrocktc::sdk::offsets::ControlOptionEditorControl::ReservedAreaEntrySize) != 0) {
            m_vector = nullptr;
            return;
        }
...
void NoTouchBorderModule::onInit() {
    const std::uintptr_t tickAddress =
        ::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::ControlOptionEditorTick);
    const std::uintptr_t renderAddress =
        ::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::ControlOptionEditorRender);
