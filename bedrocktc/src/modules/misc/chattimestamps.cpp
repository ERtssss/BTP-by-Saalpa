...
void ChatTimestampsModule::onInit() {
    const auto addMessage = ::bedrocktc::memory::resolve(
        ::bedrocktc::memory::SignatureId::GuiDataAddMessage
    );
    ...
    const auto devConsole = ::bedrocktc::memory::resolve(
        ::bedrocktc::memory::SignatureId::GuiDataDisplayDevConsoleMessage
    );
