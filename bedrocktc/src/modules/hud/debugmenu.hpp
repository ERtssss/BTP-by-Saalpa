...
class DebugMenuModule : public ::bedrocktc::Module {
public:
    DebugMenuModule();
    ...
    void updateData(float yaw, float pitch, const ::bedrocktc::sdk::Vec3& pos);
...
public:
    ::bedrocktc::sdk::Vec3  m_lastPos = {0.f, 0.f, 0.f};
    ...
    float m_yaw = 0.f;
    float m_pitch = 0.f;
    ::bedrocktc::sdk::Vec3  m_pos = {0.f, 0.f, 0.f};
    ::bedrocktc::sdk::Vec3  m_velocity = {0.f, 0.f, 0.f};
    float hudPosX = 50.f;
    float hudPosY = 50.f;
