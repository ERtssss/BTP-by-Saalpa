...
static void s_compassCallback(::bedrocktc::sdk::Player* player) {
...
void CompassModule::onInit() {
    ::bedrocktc::events::bus().subscribe<::bedrocktc::events::LocalPlayerTickEvent>([](auto& event) { s_compassCallback(event.player); });
}
