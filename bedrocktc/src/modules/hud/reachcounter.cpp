    ...
    if (g_reachCounterMod && g_reachCounterMod->enabled) {
        if (g_localPlayerNative) {
            ...
            if (level_ptr && getHitResultFn) {
                ...
                if (hit) {
                    int mType = *(int*)((uintptr_t)hit + ::bedrocktc::sdk::offsets::HitResult::mType);
                    if (mType == 0 || mType == 1) { 
                        ::bedrocktc::sdk::Vec3 startPos = *(::bedrocktc::sdk::Vec3*)((uintptr_t)hit + ::bedrocktc::sdk::offsets::HitResult::mStartPos);
                        ::bedrocktc::sdk::Vec3 pos = *(::bedrocktc::sdk::Vec3*)((uintptr_t)hit + ::bedrocktc::sdk::offsets::HitResult::mPos);
