...
static void _setupFogPlayer_hook(void* _this, void* a2) {
    ...
    if (g_fogMod && g_fogMod->enabled) {
        float* red   = (float*)((uintptr_t)_this + ::bedrocktc::sdk::offsets::LevelRendererPlayer::mFogColorRed);
        float* green = (float*)((uintptr_t)_this + ::bedrocktc::sdk::offsets::LevelRendererPlayer::mFogColorGreen);
        float* blue  = (float*)((uintptr_t)_this + ::bedrocktc::sdk::offsets::LevelRendererPlayer::mFogColorBlue);
