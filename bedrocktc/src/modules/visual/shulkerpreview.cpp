...
struct ItemStackStorage {
    alignas(16) std::byte data[::bedrocktc::sdk::offsets::ShulkerPreview::ItemStackStorageSize];
};
...
void* getStackUserData(ItemStackBase* stack) {
    ...
    return *reinterpret_cast<void**>(reinterpret_cast<std::byte*>(stack) + ::bedrocktc::sdk::offsets::ShulkerPreview::ItemStackBaseUserData);
}

Item* getStackItem(ItemStackBase* stack) {
    if (!stack) return nullptr;
    void* counter = *reinterpret_cast<void**>(reinterpret_cast<std::byte*>(stack) + ::bedrocktc::sdk::offsets::ShulkerPreview::ItemStackBaseItem);
    if (!counter) return nullptr;
    return *reinterpret_cast<Item**>(reinterpret_cast<std::byte*>(counter) + ::bedrocktc::sdk::offsets::ShulkerPreview::SharedCounterPointer);
}

std::uint16_t getItemId(Item* item) {
    if (!item) return 0;
    return *reinterpret_cast<std::uint16_t*>(reinterpret_cast<std::byte*>(item) + ::bedrocktc::sdk::offsets::ShulkerPreview::ItemId);
}

short getItemMaxDamage(Item* item) {
    if (!item) return 0;
    void** vtable = *reinterpret_cast<void***>(item);
    if (!vtable || !vtable[::bedrocktc::sdk::offsets::VTable::ItemGetMaxDamage]) return 0;
    return reinterpret_cast<short (*)(Item*)>(vtable[::bedrocktc::sdk::offsets::VTable::ItemGetMaxDamage])(item);
}
...
void* treeFindNode(void* compound, const char* key, std::size_t length) {
    ...
    void* treeRoot = base + ::bedrocktc::sdk::offsets::ShulkerPreview::CompoundTagTreeRoot;
    void* treeEnd = base + ::bedrocktc::sdk::offsets::ShulkerPreview::CompoundTagTreeEnd;
    void* node = nbtTreeFind(treeRoot, &searchKey);
    return node == treeEnd ? nullptr : node;
}

std::uint32_t nodeType(void* node) {
    return *reinterpret_cast<std::uint32_t*>(reinterpret_cast<std::byte*>(node) + ::bedrocktc::sdk::offsets::ShulkerPreview::NbtNodeType);
}

void* nodePayload(void* node) {
    return reinterpret_cast<std::byte*>(node) + ::bedrocktc::sdk::offsets::ShulkerPreview::NbtNodePayload;
}
...
bool readIntTag(void* compound, const char (&key)[N], int& output) {
    ...
    auto* value = reinterpret_cast<std::byte*>(node) + ::bedrocktc::sdk::offsets::ShulkerPreview::NbtNodeNumericValue;
...
float uiGetLineLength(void* context, Font& font, const std::string& text, float size, bool unknown) {
    ...
    if (!vtable || !vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextGetLineLength]) return 0.0f;
    using Fn = float (*)(void*, Font&, const std::string&, float, bool);
    return reinterpret_cast<Fn>(vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextGetLineLength])(context, font, text, size, unknown);
}
...
void uiDrawText(void* context, Font& font, const RectangleArea& rectangle, const std::string& text, const mce::Color& color, TextAlignment alignment, float alpha, const TextMeasureData& measure, const CaretMeasureData& caret) {
    void** vtable = getVtable(context);
    if (!vtable || !vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextDrawText]) return;
    reinterpret_cast<DrawTextFn>(vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextDrawText])(context, font, rectangle, text, color, alignment, alpha, measure, caret);
}

void uiFlushText(void* context, float value, std::optional<float> optionalValue) {
    void** vtable = getVtable(context);
    if (!vtable || !vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextFlushText]) return;
    using Fn = void (*)(void*, float, std::optional<float>);
    reinterpret_cast<Fn>(vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextFlushText])(context, value, optionalValue);
}
...
void uiDrawImage(void* context, const mce::ClientTexture& texture, const UiVec2& position, const UiVec2& size, const UiVec2& uv, const UiVec2& uvSize, bool tiled) {
    ...
    reinterpret_cast<Fn>(vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextDrawImage])(context, texture, position, size, uv, uvSize, tiled);
}
...
void uiFlushImages(void* context, const mce::Color& color, float alpha, const HashedString& material) {
    ...
    reinterpret_cast<Fn>(vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextFlushImages])(context, color, alpha, material);
}

void uiFillRectangle(void* context, const RectangleArea& rectangle, const mce::Color& color, float alpha) {
    void** vtable = getVtable(context);
    if (!vtable || !vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextFillRectangle]) return;
    using Fn = void (*)(void*, const RectangleArea&, const mce::Color&, float);
    reinterpret_cast<Fn>(vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextFillRectangle])(context, rectangle, color, alpha);
}
...
mce::TexturePtr uiGetTexture(void* context, const ResourceLocation& location, bool forceReload) {
    ...
    return reinterpret_cast<Fn>(vtable[::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextGetTexture])(context, location, forceReload);
}
...
void setHudOpacity(void* context, float opacity) {
    if (!context) return;
    void* screenContext = *reinterpret_cast<void**>(reinterpret_cast<std::byte*>(context) + ::bedrocktc::sdk::offsets::ShulkerPreview::MinecraftUIRenderContextScreenContext);
...
void* getMinecraftGame(void* client) {
    ...
    if (vtable && vtable[::bedrocktc::sdk::offsets::VTable::ClientInstanceGetMinecraftGame]) {
        void* game = reinterpret_cast<void* (*)(void*)>(vtable[::bedrocktc::sdk::offsets::VTable::ClientInstanceGetMinecraftGame])(client);
        if (game) return game;
    }
    return *reinterpret_cast<void**>(reinterpret_cast<std::byte*>(client) + ::bedrocktc::sdk::offsets::ShulkerPreview::ClientInstanceMinecraftGame);
}
...
unsigned int getItemAnimationFrame(Item* item, void* localPlayer, ItemStackBase* stack) {
    ...
    if (!vtable || !vtable[::bedrocktc::sdk::offsets::VTable::ItemGetAnimationFrameFor]) return 0;
    using Fn = unsigned int (*)(Item*, void*, int, ItemStackBase*, int);
    return reinterpret_cast<Fn>(vtable[::bedrocktc::sdk::offsets::VTable::ItemGetAnimationFrameFor])(item, localPlayer, 0, stack, 1);
}
...
void drawIcons(void* context, int cacheIndex, float originX, float originY) {
    ...
    void* client = *reinterpret_cast<void**>(reinterpret_cast<std::byte*>(context) + ::bedrocktc::sdk::offsets::ShulkerPreview::MinecraftUIRenderContextClient);
    void* screenContext = *reinterpret_cast<void**>(reinterpret_cast<std::byte*>(context) + ::bedrocktc::sdk::offsets::ShulkerPreview::MinecraftUIRenderContextScreenContext);
    if (!client || !screenContext) return;
    void* game = getMinecraftGame(client);
    if (!game) return;
    alignas(16) std::byte baseActorRenderContext[::bedrocktc::sdk::offsets::ShulkerPreview::BaseActorRenderContextStorageSize]{};
    baseActorRenderContextCtor(baseActorRenderContext, screenContext, client, game);
    void* itemRenderer = *reinterpret_cast<void**>(baseActorRenderContext + ::bedrocktc::sdk::offsets::ShulkerPreview::BaseActorRenderContextItemRenderer);
    if (!itemRenderer) {
...
bool hookVtable(const char* className, void** original, void* replacement, std::size_t slot) {
    ...
    return ::bedrocktc::hooks::install(reinterpret_cast<void*>(target), replacement, original) != nullptr;
}
...
void handleContainerSlotSelected(const ::bedrocktc::events::ContainerSlotSelectedEvent& event) {
...
void renderHoverBoxHook(void* self, void* context, void* client, void* area, float value) {
    ...
    selectedAnchorX = *reinterpret_cast<float*>(base + ::bedrocktc::sdk::offsets::ShulkerPreview::HoverRendererCursorX);
    selectedAnchorY = *reinterpret_cast<float*>(base + ::bedrocktc::sdk::offsets::ShulkerPreview::HoverRendererCursorY);
...
void ShulkerPreviewModule::onInit() {
    ...
    ::bedrocktc::events::bus().subscribe<::bedrocktc::events::ScreenStateEvent>([](auto& event) {
        if (event.screen == ::bedrocktc::events::ScreenKind::Container && event.phase == ::bedrocktc::events::ScreenPhase::Closed) {
            ShulkerPreviewHandleContainerDestroyed(event.controller);
        }
    });
    nbtTreeFind = reinterpret_cast<NbtTreeFindFn>(::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::NbtTreeFind));
    itemStackBaseLoadItem = reinterpret_cast<ItemStackBaseLoadItemFn>(::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::ItemStackBaseLoadItem));
    itemStackBaseGetDamageValue = reinterpret_cast<ItemStackBaseGetDamageValueFn>(::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::ItemStackBaseGetDamageValue));
    itemStackBaseGetRawNameId = reinterpret_cast<ItemStackBaseGetRawNameIdFn>(::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::ItemStackBaseGetRawNameId));
    baseActorRenderContextCtor = reinterpret_cast<BaseActorRenderContextCtorFn>(::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::BaseActorRenderContextCtor));
    itemRendererRenderGuiItemNew = reinterpret_cast<ItemRendererRenderGuiItemNewFn>(::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::ItemRendererRenderGuiItemNew));
    containerGetItemStack = reinterpret_cast<ContainerGetItemStackFn>(::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::ContainerScreenControllerGetItemStack));
    ::bedrocktc::events::bus().subscribe<::bedrocktc::events::ContainerSlotSelectedEvent>(
        [](auto& event) { handleContainerSlotSelected(event); }
    );
    uintptr_t screenRenderAddress = ::bedrocktc::memory::resolve(::bedrocktc::memory::SignatureId::ScreenViewRender);
    if (screenRenderAddress) {
        ::bedrocktc::hooks::install(reinterpret_cast<void*>(screenRenderAddress), reinterpret_cast<void*>(screenViewRenderHook), reinterpret_cast<void**>(&screenViewRenderOriginal));
    }
    hookVtable("17HoverTextRenderer", reinterpret_cast<void**>(&renderHoverBoxOriginal), reinterpret_cast<void*>(renderHoverBoxHook), ::bedrocktc::sdk::offsets::VTable::HoverTextRendererRenderHoverBox);
    hookVtable("24MinecraftUIRenderContext", reinterpret_cast<void**>(&drawTextOriginal), reinterpret_cast<void*>(drawTextHook), ::bedrocktc::sdk::offsets::VTable::MinecraftUIRenderContextDrawText);
