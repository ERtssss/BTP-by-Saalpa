...
static void sendGGCommand() {
    ...
    std::string* msgOnlyStr = reinterpret_cast<std::string*>(payload + ::bedrocktc::sdk::offsets::TextPacketPayload::MessageOnly::mMessage);
    msgOnlyStr->~basic_string();

    *reinterpret_cast<uint32_t*>(payload + ::bedrocktc::sdk::offsets::TextPacketPayload::mVariantIndex) = 1;

    *reinterpret_cast<uint8_t*>(payload + ::bedrocktc::sdk::offsets::TextPacketPayload::AuthorAndMessage::mType) = 1;
    new ((void*)(payload + ::bedrocktc::sdk::offsets::TextPacketPayload::AuthorAndMessage::mAuthor)) std::string("");
    std::string customGg = AutoGG::instance ? AutoGG::instance->ggMessage : "gg";
    new ((void*)(payload + ::bedrocktc::sdk::offsets::TextPacketPayload::AuthorAndMessage::mMessage)) std::string(customGg);
