...
struct MoveInputState {
    ...
    bedrocktc::sdk::Vec2 mAnalogMoveVector;
...
struct MoveInputComponent {
    ...
    bedrocktc::sdk::Vec2 mMove;
    bedrocktc::sdk::Vec2 mLookDelta;
    bedrocktc::sdk::Vec2 mInteractDir;
    bedrocktc::sdk::Vec3 mDisplacement;
    bedrocktc::sdk::Vec3 mDisplacementDelta;
    bedrocktc::sdk::Vec3 mCameraOrientation;
